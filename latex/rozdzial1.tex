...
\section {Korekcja błędów}
    Kodowanie korekcyjne umozliwia wykrywanie i korygowanie okreslonych bledow. Kod korekcyjny jest zapisywany w formie redundantnej do kodowanych danych, kodujac wartosci bitow podczas zapisu i w przypadku uszkodzenia  probuje naprawic znalezione bledy.
\subsection{Kod Hamminga}
